...
class EquipamientoController extends Controller
{
    ...
    public function index(){
        ...
        return response()->json(['success' => true, 'equipamiento' => $datos], 200);
    }
    ...
    public function store(Request $request){
        ...
        return response()->json(['success' => true, 'equipamiento' => $datosEquipamiento], 200);
    }
    ...
    public function edit($id){
        ...
        return response()->json(['success' => true, 'equipamiento' => $equipamiento], 200);
    }
